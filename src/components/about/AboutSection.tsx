...
export const AboutSection: React.FC<AboutSectionProps> = ({ onCtaClick }) => {
  return (
    ...
    >
      <ContentGrid className="py-20 sm:py-24 lg:py-32 items-center gap-12 lg:gap-16">
        {/* LEFT VISUAL AREA: Layered Overlapping Automotive Imagery (Approx 44% width) */}
        ...
        {/* RIGHT CONTENT AREA: Editorial Typography, Story & Single CTA (Approx 56% width) */}
        <div className="lg:col-span-7 flex flex-col justify-center lg:pl-4 xl:pl-8">
          {/* Small Eyebrow */}
